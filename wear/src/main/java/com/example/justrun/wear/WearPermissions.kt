...
fun requiredHeartRatePermissions(): Array<String> =
    if (Build.VERSION.SDK_INT >= 36) {
        arrayOf("android.permission.health.READ_HEART_RATE", android.Manifest.permission.ACTIVITY_RECOGNITION)
    } else {
        arrayOf(android.Manifest.permission.BODY_SENSORS, android.Manifest.permission.ACTIVITY_RECOGNITION)
    }
