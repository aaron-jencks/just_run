...
import com.example.justrun.BuildConfig
import java.io.File
...
class JustRunWearApplication : Application() {
    override fun onCreate() {
        super.onCreate()
        WearDiagnostics.init(this)
        WearDiagnostics.log("watch process started")
    }
}

object WearDiagnostics {
